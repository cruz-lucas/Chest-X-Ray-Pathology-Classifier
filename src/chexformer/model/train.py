...
from chexformer.data.chexpertdataset import CheXpertDataset
from chexformer.model.custom_trainer import MaskedLossTrainer, MultiOutputTrainer
...
def train():
    ...
    with wandb.init(
        ...
        trainer_cls = {"U-Ignore": MaskedLossTrainer, "U-MultiClass": MultiOutputTrainer}.get(
            config.trainer.uncertainty_policy, Trainer
        )
